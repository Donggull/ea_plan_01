  ...
  const handleCreateBot = async () => {
    ...
    try {
      ...
      if (knowledgeFiles.length > 0) {
        ...
        const result = await KnowledgeBaseProcessor.processKnowledgeBase(botData.id, items)
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    단계 {step}/3: {step === 1 ? '기본 정보' : step === 2 ? '지식베이스' : '설정 완료'}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  챗봇이 참조할 문서나 자료를 업로드하세요. PDF, DOC, TXT 파일을 지원합니다.
                </p>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                        isPublic ? 'bg-green-100 dark:bg-green-900/30' : 'bg-gray-100 dark:bg-gray-600'
                      }`}>
                        {isPublic ? (
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-blue-800 dark:text-blue-400 space-y-1">
                        <p><strong>이름:</strong> {botName}</p>
                        <p><strong>설명:</strong> {botDescription}</p>
                        <p><strong>지식베이스:</strong> {knowledgeFiles.length}개 파일</p>
                        <p><strong>태그:</strong> {botTags.join(', ') || '없음'}</p>
                        <p><strong>공개 설정:</strong> {isPublic ? '공개' : '비공개'}</p>
                      </div>
                    </div>
                  </div>
                </div>
